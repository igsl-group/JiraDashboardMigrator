...
//	ENTITLEMENT_PRODUCT("entitlementProduct", new JQLFuncArg(true, false)),
	...
	ISSUES_WITH_REMOVE_LINKS_BY_GLOBAL_ID(
			"issuesWithRemoteLinksByGlobalId", 
			new JQLFuncArg(true, true)),
...
//	PARENT_EPIC("parentEpic"),
	...
	PROJECTS_WHERE_USER_HAS_PERMISSION("projectsWhereUserHasPermission", new JQLFuncArg(false, false)),
	...
	REMAINING("remaining", new JQLFuncArg(true, false)),
	RUNNING("running"),
	STANDARD_ISSUE_TYPES("standardIssueTypes"),
	START_OF_DAY("startOfDay", new JQLFuncArg(true, false)),
	START_OF_MONTH("startOfMonth", new JQLFuncArg(true, false)),
	START_OF_WEEK("startOfWeek", new JQLFuncArg(true, false)),
	START_OF_YEAR("startOfYear", new JQLFuncArg(true, false)),
