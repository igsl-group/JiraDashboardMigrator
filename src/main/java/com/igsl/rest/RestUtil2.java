...
public class RestUtil2<T> extends RestUtil<T> {
	 ...
	 */
	public static <T> RestUtil2<T> getInstance(Class<T> dataClass) {
		return new RestUtil2<T>(dataClass);
	}

	protected RestUtil2(Class<T> dataClass) {
		super(dataClass);
	 ...
	 */
	public RestUtil2<T> config(Config config, boolean cloud) 
	 ...
	 */
	public RestUtil2<T> scheme(String scheme) {
		this.scheme = scheme;
		return this;
	}
	 ...
	 */
	public RestUtil2<T> host(String host) {
		this.host = host;
		return this;
	}
	 ...
	 */
	public RestUtil2<T> path(String path) {
		this.path = path;
		return this.query();
	}
	 ...
	 */
	public RestUtil2<T> pathTemplate(String variable, String value) {
	 ...
	 */
	public RestUtil2<T> pathTemplates(Map<String, String> urlTemplates) {
	 ...
	 */
	public RestUtil2<T> method(String method) {
		this.method = method;
		return this;
	}
	 ...
	 */
	public RestUtil2<T> header(String name, Object value) {
	 ...
	 */
	public RestUtil2<T> headers(MultivaluedMap<String, Object> headers) {
		if (headers == null) {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public RestUtil2<T> authenticate(String user, String password) throws UnsupportedEncodingException {
	 ...
	 */
	public RestUtil2<T> query(String name, Object value) {
	 ...
	 */
	public RestUtil2<T> query(Map<String, Object> query) {
		if (query == null) {
			query = new HashMap<>();
		}
		this.query = query;
	 ...
	 */
	public RestUtil2<T> payload(Object payload) {
	 ...
	 */
	public RestUtil2<T> throttle(long maxCall, long period) {
	 ...
	 */
	public RestUtil2<T> retry(boolean allowRetry, int maxRetryCount) {
	...
	public RestUtil2<T> retryException(Class<? extends Exception>... exceptions) {
	 ...
	 */
	public RestUtil2<T> bitwiseRetryStatus(boolean bitwiseRetryStatus) {
	 ...
	 * @param statuses
	 */
	public RestUtil2<T> retryStatus(int... statuses) {
	 ...
	 * @param bitwiseStatus
	 */
	public RestUtil2<T> bitwiseStatus(boolean bitwiseStatus) {
	 ...
	 */
	public RestUtil2<T> status(int... statuses) {
	 ...
	 * @return
	 */
	public RestUtil2<T> pagination(Pagination<T> pagination) {
